...
vec4_t Rasterizer::g_one = Vector4( 1.f, 1.f, 1.f, 1.f );
vec4_t Rasterizer::g_tile_bounds = Vector4( (float)Rasterizer::g_width, 1.f, (float)Rasterizer::g_width, 1.f );
vec4_t Rasterizer::g_fixed_point_factor = Vector4( 65536.f, 65536.f, 65536.f, 65536.f );
vec4_t Rasterizer::g_total_width_v = Vector4( (float)Rasterizer::g_total_width );
vec4_t Rasterizer::g_total_height_v = Vector4( (float)Rasterizer::g_total_height);
